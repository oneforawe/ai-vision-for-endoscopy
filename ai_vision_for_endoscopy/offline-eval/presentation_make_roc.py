#!/usr/bin/env python3
# filename: presentation_make_roc.py

# Run in `source` folder with the following command:
# python -m offline-eval.presentation_make_roc
...
def main():
    ...
    results_paths.append( {'model_short_name' : 'MNv2d',
        'data_short_name' : 'C',
        'run' : 16,
        'filepath' :
    ...
    for run in results_paths:
        ...
        pres_figs.make_roc_plot(test_set, eval_fig_path, plot_run_name)
