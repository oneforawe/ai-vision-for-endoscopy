#!/usr/bin/env python3
# filename: presentation_make_plots.py

# Run in `source` folder with the following command:
# python -m offline-eval.presentation_make_plots
...
def main():
    ...
    histories_paths.append( {'model_short_name' : 'MNv2d',
        'data_short_name' : 'C',
        'run' : 16,
        'filepath' :
        '../output/train/MNv2d/2-processed/by_abnorm/data_C/Run_16/' +
        'histories/histories_Run_16.pckl'} )
    histories_paths.append( {'model_short_name' : 'MNv2a',
        'data_short_name' : 'E',
        'run' : 2,
        'filepath' :
        '../output/train/MNv2a/2-processed/by_abnorm/data_E/Run_02/' +
        'histories/histories_Run_02.pckl'} )
    histories_paths.append( {'model_short_name' : 'MNv2d',
        'data_short_name' : 'E',
        'run' : 1,
        'filepath' :
        '../output/train/MNv2d/2-processed/by_abnorm/data_E/Run_01/' +
        'histories/histories_Run_01.pckl'} )
